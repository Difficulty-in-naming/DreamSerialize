...
{
    [global::System.Diagnostics.DebuggerDisplayAttribute("Current Count = {CurrentCount}")]
    public class SemaphoreSlim : IDisposable
    {
        ...
        public Task<bool> WaitAsync(int millisecondsTimeout)
        {
            CheckDisposed();
            var source = new TaskCompletionSource<bool>();
            global::Theraot.Core.Theraot.Threading.Timeout.Launch(() => source.SetResult(false), millisecondsTimeout);
            _asyncWaiters.Add(source);
            return source.Task;
        }
        ...
        public Task<bool> WaitAsync(TimeSpan timeout)
        {
            CheckDisposed();
            var source = new TaskCompletionSource<bool>();
            global::Theraot.Core.Theraot.Threading.Timeout.Launch(() => source.SetResult(false), timeout);
            _asyncWaiters.Add(source);
            return source.Task;
        }
        ...
        public Task<bool> WaitAsync(int millisecondsTimeout, CancellationToken cancellationToken)
        {
            ...
            CheckDisposed();
            var source = new TaskCompletionSource<bool>();
            global::Theraot.Core.Theraot.Threading.Timeout.Launch(() => source.SetResult(false), millisecondsTimeout, cancellationToken);
            cancellationToken.Register(() => source.SetCanceled());
            _asyncWaiters.Add(source);
            return source.Task;
        }
        ...
        public Task<bool> WaitAsync(TimeSpan timeout, CancellationToken cancellationToken)
        {
            ...
            CheckDisposed();
            var source = new TaskCompletionSource<bool>();
            global::Theraot.Core.Theraot.Threading.Timeout.Launch
            (
                () =>
                {
                    try
