...
namespace Theraot.Core.System.Numerics
{
    ...
    public partial struct BigInteger : IFormattable, IComparable, IComparable<BigInteger>, IEquatable<BigInteger>
    {
        ...
        /// <summary>Indicates whether the value of the current <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object is an even number.</summary>
        /// <returns>true if the value of the <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object is an even number; otherwise, false.</returns>
        public bool IsEven
        {
            get { return (InternalBits != null ? (InternalBits[0] & 1) == 0 : (InternalSign & 1) == 0); }
        }

        /// <summary>Indicates whether the value of the current <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object is <see cref="P:Theraot.Core.System.Numerics.BigInteger.One" />.</summary>
        /// <returns>true if the value of the <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object is <see cref="P:Theraot.Core.System.Numerics.BigInteger.One" />; otherwise, false.</returns>
        public bool IsOne
        {
            get { return InternalSign == 1 && InternalBits == null; }
        }

        /// <summary>Indicates whether the value of the current <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object is a power of two.</summary>
        /// <returns>true if the value of the <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object is a power of two; otherwise, false.</returns>
        ...
        /// <summary>Indicates whether the value of the current <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object is <see cref="P:Theraot.Core.System.Numerics.BigInteger.Zero" />.</summary>
        /// <returns>true if the value of the <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object is <see cref="P:Theraot.Core.System.Numerics.BigInteger.Zero" />; otherwise, false.</returns>
        public bool IsZero
        {
        ...
        /// <summary>Gets a number that indicates the sign (negative, positive, or zero) of the current <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object.</summary>
        /// <returns>A number that indicates the sign of the <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object, as shown in the following table.NumberDescription-1The value of this object is negative.0The value of this object is 0 (zero).1The value of this object is positive.</returns>
        public int Sign
        {
        ...
        /// <summary>Initializes a new instance of the <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> structure using a 32-bit signed integer value.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> structure using an unsigned 32-bit integer value.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> structure using a 64-bit signed integer value.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> structure with an unsigned 64-bit integer value.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> structure using a single-precision floating-point value.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> structure using a double-precision floating-point value.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> structure using a <see cref="T:System.Decimal" /> value.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> structure using the values in a byte array.</summary>
        ...
        /// <summary>Gets the absolute value of a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object.</summary>
        ...
        /// <summary>Adds two <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> values and returns the result.</summary>
        ...
        /// <summary>Compares two <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> values and returns an integer that indicates whether the first value is less than, equal to, or greater than the second value.</summary>
        ...
        /// <summary>Compares this instance to a second <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> and returns an integer that indicates whether the value of this instance is less than, equal to, or greater than the value of the specified object.</summary>
        /// <returns>A signed integer value that indicates the relationship of this instance to <paramref name="other" />, as shown in the following table.Return valueDescriptionLess than zeroThe current instance is less than <paramref name="other" />.ZeroThe current instance equals <paramref name="other" />.Greater than zeroThe current instance is greater than <paramref name="other" />.</returns>
        ...
        ///   <paramref name="obj" /> is not a <see cref="T:Theraot.Core.System.Numerics.BigInteger" />. </exception>
        ...
        /// <summary>Divides one <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value by another and returns the result.</summary>
        ...
        /// <summary>Divides one <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value by another, returns the result, and returns the remainder in an output parameter.</summary>
        /// <returns>The quotient of the division.</returns>
        /// <param name="dividend">The value to be divided.</param>
        /// <param name="divisor">The value to divide by.</param>
        /// <param name="remainder">When this method returns, contains a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value that represents the remainder from the division. This parameter is passed uninitialized.</param>
        /// <exception cref="T:System.DivideByZeroException">
        ///   <paramref name="divisor" /> is 0 (zero).</exception>
        ...
        /// <returns>true if the <paramref name="obj" /> parameter is a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object or a type capable of implicit conversion to a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value, and its value is equal to the value of the current <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object; otherwise, false.</returns>
        /// <param name="obj">The object to compare. </param>
        ...
        /// <summary>Returns a value that indicates whether the current instance and a specified <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object have the same value.</summary>
        /// <returns>true if this <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object and <paramref name="other" /> have the same value; otherwise, false.</returns>
        /// <param name="other">The object to compare.</param>
        ...
        /// <summary>Returns the hash code for the current <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object.</summary>
        ...
        /// <summary>Finds the greatest common divisor of two <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> values.</summary>
        ...
        /// <summary>Returns the larger of two <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> values.</summary>
        ...
        /// <summary>Returns the smaller of two <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> values.</summary>
        ...
        /// <summary>Returns the product of two <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> values.</summary>
        ...
        /// <summary>Negates a specified <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value.</summary>
        ...
        /// <summary>Adds the values of two specified <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> objects.</summary>
        /// <returns>The sum of <paramref name="left" /> and <paramref name="right" />.</returns>
        /// <param name="left">The first value to add.</param>
        /// <param name="right">The second value to add.</param>
        ...
        /// <summary>Performs a bitwise And operation on two <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> values.</summary>
        ...
        /// <summary>Performs a bitwise Or operation on two <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> values.</summary>
        ...
        /// <summary>Decrements a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value by 1.</summary>
        ...
        /// <summary>Divides a specified <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value by another specified <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value by using integer division.</summary>
        ...
        /// <summary>Returns a value that indicates whether the values of two <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> objects are equal.</summary>
        ...
        /// <summary>Returns a value that indicates whether a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value and a signed long integer value are equal.</summary>
        /// <returns>true if the <paramref name="left" /> and <paramref name="right" /> parameters have the same value; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        ...
        /// <summary>Returns a value that indicates whether a signed long integer value and a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value are equal.</summary>
        /// <returns>true if the <paramref name="left" /> and <paramref name="right" /> parameters have the same value; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        ...
        /// <summary>Returns a value that indicates whether a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value and an unsigned long integer value are equal.</summary>
        /// <returns>true if the <paramref name="left" /> and <paramref name="right" /> parameters have the same value; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        [CLSCompliant(false)]
        ...
        /// <summary>Returns a value that indicates whether an unsigned long integer value and a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value are equal.</summary>
        /// <returns>true if the <paramref name="left" /> and <paramref name="right" /> parameters have the same value; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        [CLSCompliant(false)]
        ...
        /// <summary>Performs a bitwise exclusive Or (XOr) operation on two <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> values.</summary>
        /// <returns>The result of the bitwise Or operation.</returns>
        /// <param name="left">The first value.</param>
        /// <param name="right">The second value.</param>
        public static BigInteger operator ^(BigInteger left, BigInteger right)
        ...
        /// <summary>Returns a value that indicates whether a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value is greater than another <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value.</summary>
        ...
        /// <summary>Returns a value that indicates whether a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> is greater than a 64-bit signed integer value.</summary>
        /// <returns>true if <paramref name="left" /> is greater than <paramref name="right" />; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        public static bool operator >(BigInteger left, long right)
        ...
        /// <summary>Returns a value that indicates whether a 64-bit signed integer is greater than a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value.</summary>
        /// <returns>true if <paramref name="left" /> is greater than <paramref name="right" />; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        public static bool operator >(long left, BigInteger right)
        ...
        /// <summary>Returns a value that indicates whether a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value is greater than a 64-bit unsigned integer.</summary>
        /// <returns>true if <paramref name="left" /> is greater than <paramref name="right" />; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        [CLSCompliant(false)]
        ...
        /// <summary>Returns a value that indicates whether a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value is greater than or equal to another <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value.</summary>
        /// <returns>true if <paramref name="left" /> is greater than <paramref name="right" />; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        public static bool operator >=(BigInteger left, BigInteger right)
        ...
        /// <summary>Returns a value that indicates whether a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value is greater than or equal to a 64-bit signed integer value.</summary>
        /// <returns>true if <paramref name="left" /> is greater than <paramref name="right" />; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        public static bool operator >=(BigInteger left, long right)
        ...
        /// <summary>Returns a value that indicates whether a 64-bit signed integer is greater than or equal to a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value.</summary>
        /// <returns>true if <paramref name="left" /> is greater than <paramref name="right" />; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        public static bool operator >=(long left, BigInteger right)
        ...
        /// <summary>Returns a value that indicates whether a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value is greater than or equal to a 64-bit unsigned integer value.</summary>
        /// <returns>true if <paramref name="left" /> is greater than <paramref name="right" />; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        [CLSCompliant(false)]
        ...
        /// <summary>Returns a value that indicates whether a 64-bit unsigned integer is greater than or equal to a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value.</summary>
        /// <returns>true if <paramref name="left" /> is greater than <paramref name="right" />; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        [CLSCompliant(false)]
        ...
        /// <summary>Increments a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value by 1.</summary>
        ...
        /// <summary>Returns a value that indicates whether two <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> objects have different values.</summary>
        ...
        /// <summary>Returns a value that indicates whether a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value and a 64-bit signed integer are not equal.</summary>
        /// <returns>true if <paramref name="left" /> and <paramref name="right" /> are not equal; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        public static bool operator !=(BigInteger left, long right)
        ...
        /// <summary>Returns a value that indicates whether a 64-bit signed integer and a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value are not equal.</summary>
        /// <returns>true if <paramref name="left" /> and <paramref name="right" /> are not equal; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        public static bool operator !=(long left, BigInteger right)
        ...
        /// <summary>Returns a value that indicates whether a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value and a 64-bit unsigned integer are not equal.</summary>
        /// <returns>true if <paramref name="left" /> and <paramref name="right" /> are not equal; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        [CLSCompliant(false)]
        ...
        /// <summary>Returns a value that indicates whether a 64-bit unsigned integer and a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value are not equal.</summary>
        /// <returns>true if <paramref name="left" /> and <paramref name="right" /> are not equal; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        [CLSCompliant(false)]
        ...
        /// <summary>Shifts a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value a specified number of bits to the left.</summary>
        ...
        /// <summary>Returns a value that indicates whether a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value is less than another <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value.</summary>
        ...
        /// <summary>Returns a value that indicates whether a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value is less than a 64-bit signed integer.</summary>
        /// <returns>true if <paramref name="left" /> is less than <paramref name="right" />; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        public static bool operator <(BigInteger left, long right)
        ...
        /// <summary>Returns a value that indicates whether a 64-bit signed integer is less than a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value.</summary>
        /// <returns>true if <paramref name="left" /> is less than <paramref name="right" />; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        public static bool operator <(long left, BigInteger right)
        ...
        /// <summary>Returns a value that indicates whether a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value is less than a 64-bit unsigned integer.</summary>
        /// <returns>true if <paramref name="left" /> is less than <paramref name="right" />; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        [CLSCompliant(false)]
        ...
        /// <summary>Returns a value that indicates whether a 64-bit unsigned integer is less than a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value.</summary>
        /// <returns>true if <paramref name="left" /> is less than <paramref name="right" />; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        [CLSCompliant(false)]
        ...
        /// <summary>Returns a value that indicates whether a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value is less than or equal to another <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value.</summary>
        ...
        /// <summary>Returns a value that indicates whether a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value is less than or equal to a 64-bit signed integer.</summary>
        /// <returns>true if <paramref name="left" /> is less than or equal to <paramref name="right" />; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        public static bool operator <=(BigInteger left, long right)
        ...
        /// <summary>Returns a value that indicates whether a 64-bit signed integer is less than or equal to a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value.</summary>
        /// <returns>true if <paramref name="left" /> is less than or equal to <paramref name="right" />; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        public static bool operator <=(long left, BigInteger right)
        ...
        /// <summary>Returns a value that indicates whether a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value is less than or equal to a 64-bit unsigned integer.</summary>
        /// <returns>true if <paramref name="left" /> is less than or equal to <paramref name="right" />; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        [CLSCompliant(false)]
        ...
        /// <summary>Returns a value that indicates whether a 64-bit unsigned integer is less than or equal to a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value.</summary>
        /// <returns>true if <paramref name="left" /> is less than or equal to <paramref name="right" />; otherwise, false.</returns>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        [CLSCompliant(false)]
        ...
        /// <summary>Returns the remainder that results from division with two specified <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> values.</summary>
        ...
        /// <summary>Multiplies two specified <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> values.</summary>
        ...
        /// <summary>Returns the bitwise one's complement of a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value.</summary>
        ...
        /// <summary>Shifts a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value a specified number of bits to the right.</summary>
        ...
        /// <summary>Subtracts a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value from another <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value.</summary>
        ...
        /// <summary>Returns the value of the <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> operand. (The sign of the operand is unchanged.)</summary>
        ...
        /// <summary>Converts the string representation of a number to its <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> equivalent.</summary>
        ...
        /// <summary>Converts the string representation of a number in a specified style to its <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> equivalent.</summary>
        /// <returns>A value that is equivalent to the number specified in the <paramref name="value" /> parameter.</returns>
        ...
        /// <summary>Converts the string representation of a number in a specified culture-specific format to its <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> equivalent.</summary>
        /// <returns>A value that is equivalent to the number specified in the <paramref name="value" /> parameter.</returns>
        /// <param name="value">A string that contains a number to convert.</param>
        ...
        /// <summary>Converts the string representation of a number in a specified style and culture-specific format to its <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> equivalent.</summary>
        /// <returns>A value that is equivalent to the number specified in the <paramref name="value" /> parameter.</returns>
        /// <param name="value">A string that contains a number to convert.</param>
        /// <param name="style">A bitwise combination of the enumeration values that specify the permitted format of <paramref name="value" />.</param>
        /// <param name="provider">An object that provides culture-specific formatting information about <paramref name="value" />.</param>
        ...
        /// <summary>Raises a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value to the power of a specified value.</summary>
        ...
        /// <summary>Performs integer division on two <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> values and returns the remainder.</summary>
        ...
        /// <summary>Subtracts one <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value from another and returns the result.</summary>
        /// <returns>The result of subtracting <paramref name="right" /> from <paramref name="left" />.</returns>
        /// <param name="left">The value to subtract from (the minuend).</param>
        /// <param name="right">The value to subtract (the subtrahend).</param>
        ...
        /// <summary>Converts a <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value to a byte array.</summary>
        /// <returns>The value of the current <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object converted to an array of bytes.</returns>
        ...
        /// <summary>Converts the numeric value of the current <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object to its equivalent string representation.</summary>
        /// <returns>The string representation of the current <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value.</returns>
        public override string ToString()
        {
            return FormatBigInteger(this, null, NumberFormatInfo.CurrentInfo);
        }

        /// <summary>Converts the numeric value of the current <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object to its equivalent string representation by using the specified culture-specific formatting information.</summary>
        /// <returns>The string representation of the current <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value in the format specified by the <paramref name="provider" /> parameter.</returns>
        ...
        /// <summary>Converts the numeric value of the current <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object to its equivalent string representation by using the specified format.</summary>
        /// <returns>The string representation of the current <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value in the format specified by the <paramref name="format" /> parameter.</returns>
        ...
        /// <summary>Converts the numeric value of the current <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> object to its equivalent string representation by using the specified format and culture-specific format information.</summary>
        /// <returns>The string representation of the current <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> value as specified by the <paramref name="format" /> and <paramref name="provider" /> parameters.</returns>
        /// <param name="format">A standard or custom numeric format string.</param>
        /// <param name="provider">An object that supplies culture-specific formatting information.</param>
        /// <exception cref="T:System.FormatException">
        ///   <paramref name="format" /> is not a valid format string.</exception>
        ...
        /// <summary>Tries to convert the string representation of a number to its <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> equivalent, and returns a value that indicates whether the conversion succeeded.</summary>
        /// <returns>true if <paramref name="value" /> was converted successfully; otherwise, false.</returns>
        /// <param name="value">The string representation of a number.</param>
        /// <param name="result">When this method returns, contains the <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> equivalent to the number that is contained in <paramref name="value" />, or zero (0) if the conversion fails. The conversion fails if the <paramref name="value" /> parameter is null or is not of the correct format. This parameter is passed uninitialized.</param>
        /// <exception cref="T:System.ArgumentNullException">
        ///   <paramref name="value" /> is null.</exception>
        ...
        /// <summary>Tries to convert the string representation of a number in a specified style and culture-specific format to its <see cref="T:Theraot.Core.System.Numerics.BigInteger" /> equivalent, and returns a value that indicates whether the conversion succeeded.</summary>
