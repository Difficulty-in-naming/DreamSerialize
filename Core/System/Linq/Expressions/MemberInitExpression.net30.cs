...
namespace Theraot.Core.System.Linq.Expressions
{
    ...
    public sealed class MemberInitExpression : Expression
    {
        ...
        ///<returns>A <see cref="T:Theraot.Core.System.Linq.Expressions.NewExpression" /> that represents the constructor call.</returns>
        ...
        ///<returns>A <see cref="T:System.Collections.ObjectModel.ReadOnlyCollection`1" /> of <see cref="T:Theraot.Core.System.Linq.Expressions.MemberBinding" /> objects which describe how to initialize the members.</returns>
        ...
        internal static Expression ReduceMemberInit(Expression objExpression, ReadOnlyCollection<MemberBinding> bindings, bool keepOnStack)
        {
            ...
            return Block(new TrueReadOnlyCollection<Expression>(block));
        }
    ...
    {
        ///<summary>Creates a <see cref="T:Theraot.Core.System.Linq.Expressions.MemberInitExpression" />.</summary>
        ///<returns>A <see cref="T:Theraot.Core.System.Linq.Expressions.MemberInitExpression" /> that has the <see cref="P:Theraot.Core.System.Linq.Expressions.Expression.NodeType" /> property equal to <see cref="F:Theraot.Core.System.Linq.Expressions.ExpressionType.MemberInit" /> and the <see cref="P:Theraot.Core.System.Linq.Expressions.MemberInitExpression.NewExpression" /> and <see cref="P:Theraot.Core.System.Linq.Expressions.MemberInitExpression.Bindings" /> properties set to the specified values.</returns>
        ///<param name="newExpression">A <see cref="T:Theraot.Core.System.Linq.Expressions.NewExpression" /> to set the <see cref="P:Theraot.Core.System.Linq.Expressions.MemberInitExpression.NewExpression" /> property equal to.</param>
        ///<param name="bindings">An array of <see cref="T:Theraot.Core.System.Linq.Expressions.MemberBinding" /> objects to use to populate the <see cref="P:Theraot.Core.System.Linq.Expressions.MemberInitExpression.Bindings" /> collection.</param>
        ///<exception cref="T:System.ArgumentNullException">
        ///<paramref name="newExpression" /> or <paramref name="bindings" /> is null.</exception>
        ///<exception cref="T:System.ArgumentException">The <see cref="P:Theraot.Core.System.Linq.Expressions.MemberBinding.Member" /> property of an element of <paramref name="bindings" /> does not represent a member of the type that <paramref name="newExpression" />.Type represents.</exception>
        ...
        ///<returns>A <see cref="T:Theraot.Core.System.Linq.Expressions.MemberInitExpression" /> that has the <see cref="P:Theraot.Core.System.Linq.Expressions.Expression.NodeType" /> property equal to <see cref="F:Theraot.Core.System.Linq.Expressions.ExpressionType.MemberInit" /> and the <see cref="P:Theraot.Core.System.Linq.Expressions.MemberInitExpression.NewExpression" /> and <see cref="P:Theraot.Core.System.Linq.Expressions.MemberInitExpression.Bindings" /> properties set to the specified values.</returns>
        ///<param name="newExpression">A <see cref="T:Theraot.Core.System.Linq.Expressions.NewExpression" /> to set the <see cref="P:Theraot.Core.System.Linq.Expressions.MemberInitExpression.NewExpression" /> property equal to.</param>
        ///<param name="bindings">An <see cref="T:System.Collections.Generic.IEnumerable`1" /> that contains <see cref="T:Theraot.Core.System.Linq.Expressions.MemberBinding" /> objects to use to populate the <see cref="P:Theraot.Core.System.Linq.Expressions.MemberInitExpression.Bindings" /> collection.</param>
        ///<exception cref="T:System.ArgumentNullException">
        ///<paramref name="newExpression" /> or <paramref name="bindings" /> is null.</exception>
        ///<exception cref="T:System.ArgumentException">The <see cref="P:Theraot.Core.System.Linq.Expressions.MemberBinding.Member" /> property of an element of <paramref name="bindings" /> does not represent a member of the type that <paramref name="newExpression" />.Type represents.</exception>
