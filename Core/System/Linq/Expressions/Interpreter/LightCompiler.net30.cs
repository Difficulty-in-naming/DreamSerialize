...
using AstUtils = Theraot.Core.System.Linq.Expressions.Interpreter.Utils;
...
namespace Theraot.Core.System.Linq.Expressions.Interpreter
{
    ...
    internal sealed class LightCompiler
    {
        ...
        private void CompileMemberInit(global::System.Collections.ObjectModel.ReadOnlyCollection<MemberBinding> bindings)
        {
        ...
        private void CompileNoLabelPush(Expression expr)
        {
            ...
            switch (expr.NodeType)
            {
                ...
                case ExpressionType.Extension:
                    CompileExtensionExpression(expr);
                    break;
