...
namespace Theraot.Core.System.Runtime
{
    ...
    public sealed class TargetedPatchingOptOutAttribute : Attribute
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="T:Theraot.Core.System.Runtime.TargetedPatchingOptOutAttribute" /> class.</summary>
        /// <param name="reason">The reason why the method to which the <see cref="T:Theraot.Core.System.Runtime.TargetedPatchingOptOutAttribute" /> attribute is applied is considered to be eligible for inlining across Native Image Generator (NGen) images.</param>
